...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css_files/project1.css">
    ...
    <div class="container my-4">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://github.com/jbossgotskillz/project-1/blob/main/anubis_orbit.jpg" class="d-block" height=300 alt="anubis 1">
        </div>
...
body {
    background-image:  url('rocket_ship_earth.jpg');
